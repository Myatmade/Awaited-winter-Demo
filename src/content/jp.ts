...
export const jp: SiteContent = {
  ...
  story: {
    ...
    synopsisLines: [
      ...
      "",
      "『The Awaited Winter』は、記憶の断片に導かれるバレンチナさんが",
  ...
  credits: {
    ...
    lines: [
      ...
      "",
      "音楽",
      '"No Copyright Music" : The Mountain',
      '"Sad Piano Lost Love (30 sec)" : WaveMaster',
      '"Shalom Aleichem" : NikitaKondrashev',
      '"Stairs into the Unknown (Dark Piano Music)" : JuliusH',
      '"A Little Dream" : Piano_Music',
      "",
      "音源提供: Pixabay",
    ],
  },
  characters: {
    ...
    items: {
      valentina: {
        name: "バレンチナ　イバンス",
        role: "主人公",
        tagline: "忘れられない記憶を抱えて生きる、静かな少女。",
        profile:
          "小さな町で日常の安らぎを探し続ける少女。しかし、ある冬をきっかけに、忘れようとしていた過去が再び彼女の前に現れます。",
      },
      alice: {
        name: "アリス",
        role: "相棒",
        ...
        profile:
          "活発な白い犬。大切な瞬間にはいつもバレンチナさんのそばにいて、彼女の人生に優しい光をもたらします。",
      },
      noah: {
        name: "ノア",
        role: "???",
        ...
        profile:
          "穏やかな青年。その存在はバレンチナさんの心を揺らし、未解決の何かが残されていることを思い出させます。",
      },
    },
  },
  demo: {
